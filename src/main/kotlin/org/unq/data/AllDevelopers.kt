...
import org.unq.model.Developer
...
val allDevelopers = listOf(
    ...
    Developer(
        "d_1",
        "CD PROJEKT RED",
        Image("https://media.rawg.io/media/screenshots/cf9/cf90097e47a02e91e099eb590c44ae4a.jpg")
    ),
    Developer(
        "d_2",
        "Electronic Arts",
    ...
    Developer("d_4", "Valve", Image("https://media.rawg.io/media/games/ccc/ccc0d5396e3331d58e5eb58a6a1fa1b7.jpg")),
    Developer(
        "d_5",
        "Bethesda Softworks",
        Image("https://media.rawg.io/media/games/157/1570121f5c4d240504f1eae5c3854733.jpg")
    ),
    Developer("d_6", "2K Games", Image("https://media.rawg.io/media/games/238/2383a172b4d50a7b44e07980eb7141ea.jpg")),
    Developer(
        "d_7",
        "Activision Blizzard",
    ...
    Developer("d_10", "505 Games", Image("https://media.rawg.io/media/games/ba9/ba9ad92b6d04825bd15a407c6059db94.jpg")),
    Developer(
        "d_11",
        "Sony Computer Entertainment",
        Image("https://media.rawg.io/media/games/4b6/4b67558bf04c7211aabeff179271bdd8.jpg")
    ),
    Developer("d_12", "Capcom", Image("https://media.rawg.io/media/games/053/053fc543bf488349610f1ae2d0c1b51b.jpg")),
    Developer(
        "d_13",
        "Psyonix",
        Image("https://media.rawg.io/media/screenshots/6da/6dafe3f5e9725623b4591ab7952186df.jpg")
    ),
    Developer(
        "d_14",
        "Digital Extremes",
        Image("https://media.rawg.io/media/screenshots/50e/50ef6d315fa6f0a035a4ce421d226674.jpg")
    ),
    Developer(
        "d_15",
        "Deep Silver",
    ...
    Developer("d_16", "Konami", Image("https://media.rawg.io/media/games/0f1/0f105a3d3ba6225269c4a08b43ecbb73.jpg")),
    Developer(
        "d_17",
    ...
    Developer(
        "d_18",
        "Telltale Games",
        Image("https://media.rawg.io/media/screenshots/a08/a088fa3ad0e4e0eefd276b587c68e135.jpg")
    ),
    Developer(
        "d_19",
        "1C-SoftClub",
    ...
    Developer(
        ...
        Image("https://media.rawg.io/media/games/0ca/0cab3cf814d9988277e023687ed3fd4f.jpg")
    ),
    Developer(
        "d_23",
        "Devolver Digital",
    ...
    Developer(
        "d_24",
        "Red Barrels",
        Image("https://media.rawg.io/media/screenshots/c5c/c5c5ac554749639eb0b1c67eafa419cd.jpg")
    ),
    Developer(
        "d_25",
    ...
    Developer("d_27", "THQ", Image("https://media.rawg.io/media/screenshots/202/202d74b99a0c0148ff0b3e024e6fd243.jpg")),
    Developer(
        "d_28",
        "Grinding Gear Games",
    ...
    Developer(
        "d_29",
        "Chucklefish",
        Image("https://media.rawg.io/media/screenshots/75b/75b9ef03724e9372460535d4587e03ac.jpg")
    ),
    Developer("d_30", "Bluehole", Image("https://media.rawg.io/media/games/1bd/1bd2657b81eb0c99338120ad444b24ff.jpg")),
    Developer(
        "d_31",
        "SEGA",
